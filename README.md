...
channel; when this process is not the channel's streamer, it does not invent a
second source. Radio, live streams, and videos enter through the fallback API
or the human queue according to their permissions.
